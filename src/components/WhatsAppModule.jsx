...
import { AlertCircle, Loader, MessageCircle, Bot, Settings } from 'lucide-react';
    ...
    <div className="h-screen flex flex-col bg-gray-100">
      ...
      <div className="bg-green-600 text-white px-6 py-4 flex items-center justify-between shadow-md">
        ...
        <div className="flex items-center gap-3">
          {/* Indicador de IA */}
          {aiConfig?.is_enabled && (
            <div className="flex items-center gap-2 px-3 py-1.5 bg-purple-500 rounded-lg">
      ...
      {/* Layout principal: Vista según tab seleccionado */}
      {currentView === 'chat' ? (
