...
export default function OAuthCallback() {
  ...
  const payload = useMemo(() => {
    ...
    // targetOrigin: por defecto el origin actual.
    // Si state trae app_origin, usarlo (más robusto si un día cambias dominio)
  ...
  useEffect(() => {
    ...
    // Si no hay opener, al menos cerrar solo
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 to-pink-600">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4">
        <div className="text-center">
          <div className="mb-6">
            <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full ${payload.success ? 'bg-green-100' : 'bg-red-100'}`}>
              {payload.success ? (
